...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// protected:
// 	Base_for_pointer_and_proxy() noexcept;

protected:
	Base_for_pointer_and_proxy( const typeing::Shortest_natural type, const memorying::Omp< typename A_type::the_type > &pointerToObject );

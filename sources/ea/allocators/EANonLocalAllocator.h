...
namespace EA
{
    namespace Allocator
    {
        ...
        /// allcoator callback function. There are no default implementations of these for any platform.
        ///
        /// Example usage:
        ...
        public:
            ...
            /// You must set the node allocation call back function for this class before calling AddCore,
            ...
            enum Option
            {
                ...
                kOptionEnableDebugWrites     =  5,      /// If enabled, debug info such as guard fills are written to the non-local memory and are checked in debug builds. Disabled by default.
        ...
        public: // To consider: Make this section protected instead of public. 
            ...
            struct PPM_API Node
            {
                ...
                Node*       CoalesceWithNext(Node* pMemNext);
        ...
        protected:
            ...
            static const size_t     kBinCount           = 8;                                             /// 
            ...
            static size_type NodeMatchesBlockType(const Node* pNode, int nBlockTypeFlags);
                ...
                void             AttachDebugDataToNode(const DebugDataInfo& debugDataInfo, Node* pNode);

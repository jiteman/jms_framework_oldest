...

a:JMS double namespace shrinked:jcdns:
namespace $First_Namespace$ {
namespace $Second_Namespace$ {
$end$
} // namespace $Second_Namespace$
...

a:JMS factory method base class declaration:jcfmbcd:
class $FILE_BASE$ {
...
// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
public:
	virtual ~$FILE_BASE$() noexept;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
	$FILE_BASE$() noexept;
	
	static $FILE_BASE$ create() noexept;
...

a:JMS factory method base class implementation:jcfmbci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// static
$FILE_BASE$ $FILE_BASE$::create() noexept {
	return $FILE_BASE$();
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS factory method class declaration:jcfmcd:
class $FILE_BASE$ {
...

a:JMS factory method class implementation:jcfmci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS factory method derived class declaration:jcfmdcd:
class $FILE_BASE$ :
	public $Base_class$
{
...

a:JMS factory method derived class declaration headers:jcfmdcdh:
#include "$Base_class$.h"



a:JMS factory method derived class implementation:jcfmdci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
const $FILE_BASE$ &$FILE_BASE$::operator =( const $FILE_BASE$ &another ) noexept {
	...
	static_cast< $Base_class$ & >( *this ) = another;
	return *this;	
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS factory method realization declaration:jcfmrd:
class $FILE_BASE$ :
...

a:JMS factory method realization implementation:jcfmri:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS factory method template base class declaration:jcfmbcd:
...

a:JMS factory method template base class implementation:jcfmtbci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS factory method template class declaration:jcfmtcd:
template< class A_type >
class $FILE_BASE$ {
...

a:JMS factory method template class implementation:jcstci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS factory method template derived class declaration:jcfmtdcd:
template< class A_type >
class $FILE_BASE$ :
	public $Base_class$< A_type >
{

public:
	// virtuals $Base_class$< A_type >
	//~virtuals $Base_class$< A_type >
...

a:JMS factory method template derived class declaration headers:jcfmdcdh:
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS factory method template realization declaration:jcfmtrd:
template< class A_type >
class $FILE_BASE$ :
...

a:JMS factory method template realization implementation:jcfmtri:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...

a:JMS pattern singleton interface declaration:jcpsid:

a:JMS pattern singleton interface declaration headers:jcpsidh:

a:JMS pattern singleton interface implementation:jcpsii:

a:JMS pattern singleton interface implementation headers:jcpsiih:

a:JMS pattern singleton realization declaration:jcpsrd:

a:JMS pattern singleton realization declaration headers:jcpsrdh:

a:JMS pattern singleton realization implementation:jcpsri:

a:JMS pattern singleton realization implementation headers:jcpsrih:

a:JMS quadruple namespace:jcqn:
namespace $First_Namespace$ {
namespace $Second_Namespace$ {
...

a:JMS quadruple namespace shrinked:jcqns:
namespace $First_Namespace$ {
namespace $Second_Namespace$ {
namespace $Third_Namespace$ {
namespace $Fourth_Namespace$ {
...

a:JMS simple base class declaration:jcsbcd:
class $FILE_BASE$ {
...

a:JMS simple base class implementation:jcsbci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS simple derived class declaration:jcsdcd:
class $FILE_BASE$ :
	public $Base_class$
{
...

a:JMS simple derived class declaration headers:jcsdcdh:
#include "$Base_class$.h"



a:JMS simple derived class implementation:jcsdci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS simple realization declaration:jcsrd:
class $FILE_BASE$ :
	public $Interface_name$
{
...

a:JMS simple realization declaration headers:jcrdh:
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS simple template base class declaration:jcsbcd:
template< class A_type >
class $FILE_BASE$ {
...

a:JMS simple template base class implementation:jcstbci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS simple template class declaration:jcstcd:
template< class A_type >
class $FILE_BASE$ {
...

a:JMS simple template class implementation:jcstci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS simple template derived class declaration:jcstdcd:
template< class A_type >
class $FILE_BASE$ :
	public $Base_class$< A_type >
{
...

a:JMS simple template derived class implementation:jcstdci:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

a:JMS simple template realization declaration:jcstrd:
template< class A_type >
class $FILE_BASE$ :
	public $Interface_name$< A_type >
{
...

a:JMS simple template realization implementation:jcstri:
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...

a:JMS single namespace shrinked:jcsns:
namespace $First_Namespace$ {
$end$
} // namespace $First_Namespace$
...

a:JMS template data member implementation::
$FILE_BASE$< A_type >::$selected$$end$
a:JMS template forward declaration:jctfd:
template< class A_type > class $FILE_BASE$;

...

a:JMS triple namespace shrinked:jctns:
namespace $First_Namespace$ {
namespace $Second_Namespace$ {
namespace $Third_Namespace$ {
$end$

...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
ms_windows_MutexSpecial::ms_windows_MutexSpecial( const Automatic< CRITICAL_SECTION > &criticalSection ) throw()
	:
...
ms_windows_MutexSpecial::ms_windows_MutexSpecial( const ms_windows_MutexSpecial & ) throw( Exception ) { // other
	Should::neverViolateCopyingProhibition( "ms_windows_MutexSpecial::ms_windows_MutexSpecial()" );
}

const ms_windows_MutexSpecial &ms_windows_MutexSpecial::operator =( const ms_windows_MutexSpecial &other ) throw( Exception ) {

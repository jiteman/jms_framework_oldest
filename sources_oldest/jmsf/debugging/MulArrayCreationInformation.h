...
class JMSF_DLL_INTERFACE MulArrayCreationInformation {

public:
	~MulArrayCreationInformation() throw();

	MulArrayCreationInformation(
...
public:
	MulArrayCreationInformation( const MulArrayCreationInformation &other ) throw();

private:
	const MulArrayCreationInformation &operator =( const MulArrayCreationInformation &other ) throw();

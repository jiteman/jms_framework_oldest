...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
	Mbd_size_comparator( const Mbd_size_comparator &another ) noexcept;
	const Mbd_size_comparator &operator =( const Mbd_size_comparator &another ) noexcept;

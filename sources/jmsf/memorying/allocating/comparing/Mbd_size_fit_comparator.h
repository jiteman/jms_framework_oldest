...
public:
	...
	~Mbd_size_fit_comparator() noexept;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
	Mbd_size_fit_comparator( const Mbd_size_fit_comparator &another ) noexept;
	const Mbd_size_fit_comparator &operator =( const Mbd_size_fit_comparator &another ) noexept;

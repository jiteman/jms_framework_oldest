...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
private: friend class ::jmsf::Singleton< null_NewVoiceFileStatisticsProcess >;
...
private:
	null_NewVoiceFileStatisticsProcess( const null_NewVoiceFileStatisticsProcess &other ) throw();
	const null_NewVoiceFileStatisticsProcess &operator =( const null_NewVoiceFileStatisticsProcess &other ) throw();

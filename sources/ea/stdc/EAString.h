...
/// If nSourceLength is ~0 then the source is copied until a 0 byte is encountered.
...
/// own trailing 0 byte.
///
EASTDC_API int Strlcpy(char16_t* pDestination, const char8_t*  pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
EASTDC_API int Strlcpy(char8_t*  pDestination, const char16_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);

EASTDC_API int Strlcpy(char32_t* pDestination, const char8_t*  pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
EASTDC_API int Strlcpy(char8_t*  pDestination, const char32_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);

EASTDC_API int Strlcpy(char32_t* pDest, const char16_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
EASTDC_API int Strlcpy(char16_t* pDest, const char32_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);

#if EA_WCHAR_UNIQUE
    EASTDC_API int Strlcpy(char8_t* pDestination, const wchar_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
    EASTDC_API int Strlcpy(char16_t* pDestination, const wchar_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
    EASTDC_API int Strlcpy(char32_t* pDestination, const wchar_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
    EASTDC_API int Strlcpy(wchar_t* pDestination, const char8_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
    EASTDC_API int Strlcpy(wchar_t* pDestination, const char16_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
    EASTDC_API int Strlcpy(wchar_t* pDestination, const char32_t* pSource, size_t nDestCapacity, size_t nSourceLength = (size_t)~0);
#endif

// To consider: Enable this for completeness with the above:
//EASTDC_API int Strlcpy(char8_t*  pDestination, const char8_t*  pSource, size_t nDestCapacity, size_t nSourceLength); // nSourceLength = (size_t)~0
//EASTDC_API int Strlcpy(char16_t* pDestination, const char16_t* pSource, size_t nDestCapacity, size_t nSourceLength); // nSourceLength = (size_t)~0. We can't define the default parameter because if we did then Strlcpy would conflict with the other version of Strlcpy.
//EASTDC_API int Strlcpy(char32_t* pDestination, const char32_t* pSource, size_t nDestCapacity, size_t nSourceLength); // nSourceLength = (size_t)~0. We can't define the default parameter because if we did then Strlcpy would conflict with the other version of Strlcpy.
...
{
    return Internal::Strlcpy1Class<Dest, Source>::Strlcpy1Impl(d, s);
}
...
template <typename Dest, typename Source>
inline Dest Strlcpy(const Source* pSource, size_t sourceLength = (size_t)~0)
{
    if(sourceLength == (size_t)~0)
        sourceLength = Strlen(pSource);
...
/// This is similar to the stristr and wcsstr C functions.
///
...
/// terminating null character.
/// This is similar to the strrstr C function.
///
...
/// This is similar to the strirstr C function.
///
...
///
EASTDC_API int StrcmpNumeric (const char8_t*  pString1, const char8_t*  pString2, size_t length1 = (size_t)~0, size_t length2 = (size_t)~0, char8_t  decimal = '.', char8_t  thousandsSeparator = ',');
EASTDC_API int StrcmpNumeric (const char16_t* pString1, const char16_t* pString2, size_t length1 = (size_t)~0, size_t length2 = (size_t)~0, char16_t decimal = '.', char16_t thousandsSeparator = ',');
EASTDC_API int StrcmpNumeric (const char32_t* pString1, const char32_t* pString2, size_t length1 = (size_t)~0, size_t length2 = (size_t)~0, char32_t decimal = '.', char32_t thousandsSeparator = ',');
#if EA_WCHAR_UNIQUE
    EASTDC_API int StrcmpNumeric (const wchar_t* pString1, const wchar_t* pString2, size_t length1 = (size_t)~0, size_t length2 = (size_t)~0, wchar_t decimal = '.', wchar_t thousandsSeparator = ',');
#endif

EASTDC_API int StricmpNumeric(const char8_t*  pString1, const char8_t*  pString2, size_t length1 = (size_t)~0, size_t length2 = (size_t)~0, char8_t  decimal = '.', char8_t  thousandsSeparator = ',');
EASTDC_API int StricmpNumeric(const char16_t* pString1, const char16_t* pString2, size_t length1 = (size_t)~0, size_t length2 = (size_t)~0, char16_t decimal = '.', char16_t thousandsSeparator = ',');
EASTDC_API int StricmpNumeric(const char32_t* pString1, const char32_t* pString2, size_t length1 = (size_t)~0, size_t length2 = (size_t)~0, char32_t decimal = '.', char32_t thousandsSeparator = ',');
#if EA_WCHAR_UNIQUE
    EASTDC_API int StricmpNumeric(const wchar_t* pString1, const wchar_t* pString2, size_t length1 = (size_t)~0, size_t length2 = (size_t)~0, wchar_t decimal = '.', wchar_t thousandsSeparator = ',');
#endif
...
///    "15e-0"
///
EASTDC_API size_t ReduceFloatString(char8_t*  pString, size_t nLength = (size_t)~0);
EASTDC_API size_t ReduceFloatString(char16_t* pString, size_t nLength = (size_t)~0);
EASTDC_API size_t ReduceFloatString(char32_t* pString, size_t nLength = (size_t)~0);
#if EA_WCHAR_UNIQUE
    EASTDC_API size_t ReduceFloatString(wchar_t* pString, size_t nLength = (size_t)~0);
#endif
...
namespace StdC
{
    ...
    #if (EA_WCHAR_SIZE == 2)
        #define EASTDC_UNICODE_CHAR_PTR_PTR_CAST(x) reinterpret_cast<char16_t **>(x)
    ...
    {
        return Strlcpy(EASTDC_UNICODE_CHAR_PTR_CAST(pDestination), pSource, nDestCapacity, nSourceLength);
    }

    inline int Strlcpy(wchar_t* pDestination, const char16_t* pSource, size_t nDestCapacity, size_t nSourceLength)
    {
        #if (EA_WCHAR_SIZE == 2)
            return Strlcpy(EASTDC_UNICODE_CHAR_PTR_CAST(pDestination), pSource, nDestCapacity);
        #else
            return Strlcpy(EASTDC_UNICODE_CHAR_PTR_CAST(pDestination), pSource, nDestCapacity, nSourceLength);
        #endif
    }
    ...
    {
        return Strlcpy(pDestination, EASTDC_UNICODE_CONST_CHAR_PTR_CAST(pSource), nDestCapacity, nSourceLength);
    }

    inline int Strlcpy(char16_t* pDestination, const wchar_t* pSource, size_t nDestCapacity, size_t nSourceLength)
    {
        #if (EA_WCHAR_SIZE == 2)
            return Strlcpy(pDestination, EASTDC_UNICODE_CONST_CHAR_PTR_CAST(pSource), nDestCapacity);
        #else
            return Strlcpy(pDestination, EASTDC_UNICODE_CONST_CHAR_PTR_CAST(pSource), nDestCapacity, nSourceLength);
        #endif
    }
    ...
    // UTF8 <-> UTF16 encoding conversion 
    inline size_t Strlcat(wchar_t* pDestination, const char8_t*  pSource, size_t nDestCapacity)
    {
        ...
        {
            return Strlcat(reinterpret_cast<char16_t *>(pDestination), pSource, nDestCapacity);
        }
    #endif
        ...
        {
            return Strlcat(reinterpret_cast<char32_t *>(pDestination), pSource, nDestCapacity);
        }
    #endif
    ...
    inline size_t Strlcat(char8_t* pDestination, const wchar_t*  pSource, size_t nDestCapacity)
    {
        ...
        {
            return Strlcat(pDestination, reinterpret_cast<const char16_t *>(pSource), nDestCapacity);
        }
    #endif
        ...
        {
            return Strlcat(pDestination, reinterpret_cast<const char32_t *>(pSource), nDestCapacity);
        }
    #endif
    ...
    template <typename Source, typename Dest>  // ConverrString has been renamed to Strlcpy and the template arguments reversed.

...
#elif defined(EA_PLATFORM_REVOLUTION) || defined(EA_PLATFORM_PLAYSTATION2) || defined(EA_PLATFORM_CTR)
...
//
        ...
        #define EASTDC_UTC_TIME_AVAILABLE 0
    #else
...
namespace StdC
{
    ...
    public:
        ...
        // See the GetSeconds function for the specification of nSeconds.

...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : high-level application API (realizationementation)                * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of the high-level function interface        * */
/* *             for applications.                                          * */
/* *                                                                        * */
...
/* *             - realizationemented support for freeze/reset/resume & go_xxxx    * */
...
typedef struct {
                 mng_pchar  zFunction;
                 mng_uint8  iMajor;    /* Major == 0 means not realizationemented ! */ 
                 mng_uint8  iMinor;
                 mng_uint8  iRelease;
               } mng_func_entry;
...
MNG_LOCAL mng_func_entry const func_table [] =
  {                                    /* keep it alphabetically sorted !!!!! */
    ...
    {"mng_get_srealizationicity",         1, 0, 0},
    {"mng_get_speed",              1, 0, 0},
    {"mng_get_srgb",               1, 0, 0},
    ...
    {"mng_set_speed",              1, 0, 0},
    {"mng_set_srgb",               1, 0, 0},
    {"mng_set_srgbrealizationicit",       1, 0, 1},
    ...
    {"mng_updatemngsrealizationicity",    1, 0, 0},
...
mng_retcode MNG_DECL mng_cleanup (mng_handle* hHandle)
{
  ...
  mng_reset (*hHandle);                /* do an realizationicit reset to cleanup most stuff */

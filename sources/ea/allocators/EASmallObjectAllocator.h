...
namespace EA
{
    namespace Allocator
    {
        ...
        /// allocator, you may want to use your own hand-tailured small block 
        ...
        public:
            ...
            /// This function is used to allocate CoreBlocks which fund the individual memory pools.
            /// The alignment requested will be the same alignment required for the pool this CoreBlock
            /// will be associated with. The alignment offset will be a value which reflects the CoreBlock
            /// header which will be placed at the front of the CoreBlock. If the memory returned by this
            /// function doesn't have the required alignment/alignment offset, the user data will non-optimally
            /// organized and thus some space will be wasted.

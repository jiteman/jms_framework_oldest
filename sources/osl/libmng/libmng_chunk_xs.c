...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : chunk access functions (realizationementation)                    * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of the chunk access functions               * */
/* *                                                                        * */
...
/* *             - added function to set srealizationicity field                   * */
...
/* *             - B578940 - unrealizationemented functions return errorcode       * */
                                        ...
                                        mng_uint32 *iSrealizationicity)
{
  ...
  *iSrealizationicity = pChunk->iSrealizationicity;
                                        ...
                                        mng_uint32 iSrealizationicity)
{
  ...
  ((mng_mhdrp)pChunk)->iSrealizationicity = iSrealizationicity;
                                         ...
                                         mng_getcanvasline fGetcanvasline)
{
  ...
  return MNG_FNNOTrealizationEMENTED;
}
...
mng_retcode MNG_DECL mng_updatemngsrealizationicity (mng_handle hHandle,
                                              mng_uint32 iSrealizationicity)
{
  mng_datap  pData;
  mng_chunkp pChunk;
...
#ifdef MNG_SUPPORT_TRACE
  MNG_TRACE (((mng_datap)hHandle), MNG_FN_UPDATEMNGSrealizationICITY, MNG_LC_START);
#endif
...
#ifdef MNG_SUPPORT_TRACE
  MNG_TRACE (((mng_datap)hHandle), MNG_FN_UPDATEMNGSrealizationICITY, MNG_LC_END);
#endif

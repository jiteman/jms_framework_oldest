...
namespace EA
{
    namespace Thread
    {
        ...
        EATHREADLIB_API size_t GetCallstack(void* callstack[], size_t maxDepth, const CallstackContext* pContext = NULL);
            ...
            ///
            EATHREADLIB_API size_t GetCallstackSPU(void* callstack[], size_t maxDepth, intptr_t spuThreadId);
        #endif
        ...
        #elif defined(__MWERKS__) && defined(EA_PROCESSOR_POWERPC) // This covers EA_PLATFORM_GAMECUBE and EA_PLATFORM_REVOLUTION
        ...
        EATHREADLIB_API void* GetStackLimit();
            ...
            {                                              \
                uint64_t gpr1;                             \
                __asm { std r1, gpr1 };                    \
                ::EA::Thread::SetStackBase((void*)gpr1);   \
            }

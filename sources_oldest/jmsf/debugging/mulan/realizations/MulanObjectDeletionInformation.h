...
class MulanObjectDeletionInformation {

public:
	~MulanObjectDeletionInformation() throw();

	MulanObjectDeletionInformation(
...
public:
	MulanObjectDeletionInformation() throw();
	MulanObjectDeletionInformation( const MulanObjectDeletionInformation &other ) throw();

private:
	const MulanObjectDeletionInformation &operator =( const MulanObjectDeletionInformation &other ) throw();

...
void mixin_osie_Thread::setPriority( const natural_size priorityLevel ) throw( Exception ) {
	_mixin_Thread_HiddenThread->setPriority( priorityLevel );
}

void mixin_osie_Thread::setHiddenThread( Pointer< hiddens::hidden_Thread > hiddenThread ) throw() {

...
#include "EA/Basic/config/eacompiler.h"

// Identify traits which this compiler supports, or does not support
#include "EA/Basic/config/eacompilertraits.h"
...
///////////////////////////////////////////////////////////////////////////////
    ...
    #define EABASE_VERSION   "2.00.32"
    #define EABASE_VERSION_N  20032
#endif
...
//
    ...
    #endif
#elif defined(EA_PLATFORM_UNIX) || defined(EA_PLATFORM_MINGW) || defined(__APPLE__) || defined(_BSD_SIZE_T_) || defined(__QNX__) // _BSD_SIZE_T_ indicates that Unix-like headers are present, even though it may not be a true Unix platform.
    #include <sys/types.h>
#endif
...
//
    ...
    // static_assert is defined by the compiler.
        ...
        #else
            #if defined(__EDG__)
                // We define the following as an enum to avoid the warning on compilers that we have an extra semicolon if this was defined to nothing.
                #define static_assert(expression, description) enum { EA_PREPROCESSOR_JOIN(static_assert_, __LINE__) }
            #else

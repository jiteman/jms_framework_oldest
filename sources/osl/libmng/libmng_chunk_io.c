...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : Chunk I/O routines (realizationementation)                        * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of chunk input/output routines              * */
/* *                                                                        * */
...
/* *             - realizationemented JNG support                                  * */
...
/* *             - realizationemented support for PPLT chunk                       * */
...
/* *             - added check for srealizationicity-bits in MHDR                  * */
/* *             0.9.3 - 08/12/2000 - G.Juyn                                * */
/* *             - fixed check for srealizationicity-bits in MHDR (JNG)            * */
/* *             0.9.3 - 08/12/2000 - G.Juyn                                * */
...
/* *             - fixed srealizationicity-check in compliance with draft 81/0.98a * */
...
/* *             - realizationemented nEED "xxxx" (where "xxxx" is a chunkid)      * */
...
/* ************************************************************************** */
/* *                                                                        * */
/* * Helper routines to srealizationify chunk-data extraction                      * */
/* *                                                                        * */
/* ************************************************************************** */
...
/* ************************************************************************** */
/* *                                                                        * */
/* * Helper routines to srealizationify chunk writing                              * */
/* *                                                                        * */
/* ************************************************************************** */
...
READ_CHUNK (mng_read_mhdr)
{
  ...
  {                                    /* initialize storage */
    ...
    ((mng_mhdrp)*ppChunk)->iSrealizationicity = pData->iSrealizationicity;
  }
#endif /* MNG_STORE_CHUNKS */
...
WRITE_CHUNK (mng_write_mhdr)
{
  ...
  mng_put_uint32 (pRawdata+24, pMHDR->iSrealizationicity);

...
/* EA_HAVE_XXX_H */
    ...
    #if (defined(__GNUC__) && (__GNUC__ >= 3)) || defined(__MWERKS__) || defined(__EDG__)
    ...
    #if defined(EA_PLATFORM_UNIX)
        #define EA_HAVE_SEMAPHORE_H 1 /* Identifies if Unix <semaphore.h> is available. */
    #else
        ...
        #define EA_HAVE_DIRENT_H 1 /* Identifies if Unix <semaphore.h> is available. */
    #else
        #define EA_NO_HAVE_DIRENT_H 1
    #endif
#endif
...
/* EA_HAVE_XXX_IMPL*/
    ...
    #else
        #define EA_NO_HAVE_std_terminate 1
    #endif
#endif

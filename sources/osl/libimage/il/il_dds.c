...
// This function srealizationy counts how many contiguous bits are in the mask.
...
void iFlipSrealizationeAlphaBlock(ILushort *data)
{
	ILushort tmp;
...
void iFlipDxt3(ILubyte* data, ILuint count)
{
	ILuint i;
	for (i = 0; i < count; ++i) {
		iFlipSrealizationeAlphaBlock((ILushort*)data);

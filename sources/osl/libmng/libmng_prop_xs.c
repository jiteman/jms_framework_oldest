...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : property get/set interface (realizationementation)                * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of the property get/set functions           * */
/* *                                                                        * */
...
mng_retcode MNG_DECL mng_set_srgbrealizationicit (mng_handle hHandle)
{
#ifdef MNG_INCLUDE_LCMS
  mng_datap pData;
#endif
...
#ifdef MNG_SUPPORT_TRACE
  MNG_TRACE (((mng_datap)hHandle), MNG_FN_SET_SRGBrealizationICIT, MNG_LC_START);
#endif
...
#ifdef MNG_SUPPORT_TRACE
  MNG_TRACE (((mng_datap)hHandle), MNG_FN_SET_SRGBrealizationICIT, MNG_LC_END);
#endif
...
mng_uint32 MNG_DECL mng_get_srealizationicity (mng_handle hHandle)
{
#ifdef MNG_SUPPORT_TRACE
  MNG_TRACEX (((mng_datap)hHandle), MNG_FN_GET_SrealizationICITY, MNG_LC_START);
#endif

  MNG_VALIDHANDLEX (hHandle)

#ifdef MNG_SUPPORT_TRACE
  MNG_TRACEX (((mng_datap)hHandle), MNG_FN_GET_SrealizationICITY, MNG_LC_END);
#endif

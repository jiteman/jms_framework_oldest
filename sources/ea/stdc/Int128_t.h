...
//
    ...
    #if (defined(EA_PLATFORM_XENON) || defined(EA_PLATFORM_PS3) || defined(EA_PLATFORM_PLAYSTATION2)) || (EA_PLATFORM_PTR_SIZE == 8)
        #define EA_PLATFORM_WORD_SIZE 8 // 64 bit words/registers for the platform. Not necessarily the same as pointer/address size.
    #else
    ...
    #if (EA_PLATFORM_WORD_SIZE >= 8) && !defined(EA_PLATFORM_PLAYSTATION2)
...
#if defined(__MWERKS__)                             // CodeWarrior always defines int as 32 bits, and int32_t as long.
    #define INT128_INT_TYPE  int
    #define INT128_UINT_TYPE unsigned int
#elif defined(EA_PLATFORM_MICROSOFT)                // Microsoft always defines long as 32 bits, and int32_t as int.

...
#include "ea/eathreading/internal/config.h"
    ...
    // Do nothing.
#elif defined(EA_PROCESSOR_MIPS) || defined(EA_PLATFORM_PLAYSTATION2) || defined(EA_PLATFORM_PLAYSTATION2_IOP) || defined(EA_PLATFORM_PSP)
    #include <eathread/mips/eathread_sync_mips.h>
#elif defined(EA_PROCESSOR_POWERPC) || defined(EA_PLATFORM_GAMECUBE) || defined(EA_PLATFORM_REVOLUTION) || defined(EA_PLATFORM_XENON) || defined(EA_PLATFORM_PS3) || defined(EA_PLATFORM_OSX)
    #include <eathread/powerpc/eathread_sync_powerpc.h>
#elif defined(EA_PLATFORM_PSP2)
    #include <eathread/psp2/eathread_sync_psp2.h>
...
#elif defined(EA_PLATFORM_ANDROID) // todo; test on other platforms for necessity and change to: defined(EA_PROCESSOR_ARM) && defined(EA_COMPILER_GNUC)

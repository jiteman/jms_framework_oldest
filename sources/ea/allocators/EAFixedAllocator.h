...
namespace EA
{
    namespace Allocator
    {
        ...
        public:
            ...
            /// However, an nInitialSize of -1 causes no initial allocation to take place.
        ...
        struct NamedFixedAllocatorContext
        {
            const char8_t*  mpName;
            uint32_t        mFlags;

            NamedFixedAllocatorContext(const char8_t* pName, uint32_t flags = 0)
            {
                mpName = pName;
                mFlags = flags;
            }

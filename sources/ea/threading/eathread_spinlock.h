...
#include <new> // include new for placement new operator
    ...
    // #include <eathread/mips/eathread_spinlock_mips.h>
#elif defined(EA_PROCESSOR_POWERPC)
    // The reference code below is probably fine.
    // #include <eathread/powerpc/eathread_spinlock_powerpc.h>
...
namespace EA
{
    namespace Thread
    {
        ...
        #ifdef _MSC_VER
            #pragma warning(push)
            #pragma warning(disable: 4100) // Compiler mistakenly claims pSpinLock is unreferenced
        #endif

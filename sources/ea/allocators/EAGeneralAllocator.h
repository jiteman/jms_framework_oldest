...
namespace EA
{
    namespace Allocator
    {
        ...
        /// 
        class PPM_API GeneralAllocator
        { 
        public:
            /// kTypeId
            ...
            /// Core memor is the underlying large area of memory used internally by GeneralAllocator to 
            ...
            enum CoreType
            {
                ...
                kCoreTypeMMap,              /// Created from mmap (Unix) or VirtualAlloc(Microsoft), PS3 sys_memory_allocate.
                kCoreTypeKernelAlloc,       /// XBox XPhysicalAlloc, PSVita sceKernelAllocMemBlock.
                kCoreTypeUserDefined        /// Only the user can know how to free this or any numerical type not enumerated here.
            };
            ...
            /// CoreExtendFunction
            /// Allows the user to extend the given core memory, if possible.
            ...
            /// GeneralAllocator
            /// @brief Constructs an instance of an allocator.
            ...
            PPM_VIRTUAL bool Init(void* pInitialCore = NULL, size_t nInitialCoreSize = 0, 
                                  bool bShouldFreeInitialCore = true, bool bShouldTrimInitialCore = false, 
                                  CoreFreeFunction pInitialCoreFreeFunction = NULL, void* pInitialCoreFreeFunctionContext = NULL,
                                  CoreExtendFunction pInitialCoreExtendFunction = NULL, void* pInitialCoreExtendFunctionContext = NULL);
            ...
            /// Input 'nAlignmentOffset' must be a multiple of 8; this is so because
            /// the minimum alignment for any returned memory is 8 and thus an 
            /// offset that is not a multiple of 8 would not be possible.
            ...
            bool AddCore(void* pCore, size_t nSize, bool bShouldFreeCore = false, bool bShouldTrimCore = false, 
                         CoreFreeFunction pCoreFreeFunction = NULL, void* pCoreFreeFunctionContext = NULL,
                         CoreExtendFunction pCoreExtendFunction = NULL, void* pCoreExtendFunctionContext = NULL);
            ...
            enum Option
            {
                ...
                kOptionExecutableCore        = 18       /// If true then internally allocated core memory is allocated as executable in addition to read/write. This is disabled by default.
            };
            ...
            PPM_VIRTUAL size_t GetBlockSize(const void* pData, bool bNetSize = false) const;
...
namespace EA
{
    namespace Allocator
    {
        ...
        {
            // Check if a size is so large that it would wrap around zero when
            // padded and aligned. To simplify some other code, the bound is made
            // low enough so that adding kMinAllocSize will also not wrap around zero.
            return (nSize < (size_type)(-2 * (ssize_type)kMinAllocSize));
        }

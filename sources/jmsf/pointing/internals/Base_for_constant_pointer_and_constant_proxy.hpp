...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
//protected:
// 	Base_for_constant_pointer_and_constant_proxy() throw();

protected:
	Base_for_constant_pointer_and_constant_proxy( typing::Shortest_natural type, const memorying::Omp< typename A_type::the_type > &pointerToObject );

...
void int128_t_base::operatorMul(const int128_t_base& a, const int128_t_base& b, int128_t_base& result)
{
    ...
    //              Windows UnsignedMultiply128 and GCC's built-in int128_t.
            ...
            // To do: Implement this entire function in PowerPC-64 asm.

            #pragma warning(disable: 4189) // local variable is initialized but not referenced
            #ifdef std // STLPort #defines 'std' to be something else.
                #undef std
            #endif

            // With Xenon we can use the mulhdu instruction to get the high bits of the result of a 64 bit x 64 bit multiply.
            uint64_t nLow00 = a.mPart0 * b.mPart0;
            uint64_t nHigh00, a0 = a.mPart0, a1 = a.mPart1, b0 = b.mPart0, b1 = b.mPart1;
            __asm{ // uint64_t nHigh00 = a.mPart0 * b.mPart0;
                ld r8, a0
                ld r9, b0
                mulhdu r10, r8, r9
                std r10, nHigh00
            ...
            uint64_t nLow01 = a.mPart0 * b.mPart1;
            uint64_t nHigh01;
            __asm{ // uint64_t nHigh01 = a.mPart0 * b.mPart1;
                ld r8, a0
                ld r9, b1
                mulhdu r10, r8, r9
                std r10, nHigh01
            ...
            uint64_t nLow10 = a.mPart1 * b.mPart0;
            uint64_t nHigh10;
            __asm{ // nHigh10 = a.mPart1 * b.mPart0;
                ld r8, a1
                ld r9, b0
                mulhdu r10, r8, r9
                std r10, nHigh10
            ...
            int128_t v00(nLow00, nHigh00);
            int128_t v01(nLow01, nHigh01);
            int128_t v10(nLow10, nHigh10);

            result  =  v00;
            operatorPlus(result, v01 << 64, result);
            operatorPlus(result, v10 << 64, result);

        #elif defined(DISABLED_PLATFORM_WIN64)
...
//
int128_t int128_t::StrToInt128(const char* pValue, char** ppEnd, int nBase) const
{
...
// This is probably the most general and useful of the C atoi family of functions.
//
int128_t int128_t::StrToInt128(const wchar_t* pValue, wchar_t** ppEnd, int nBase) const
{
...
// This is probably the most general and useful of the C atoi family of functions.
//
uint128_t uint128_t::StrToInt128(const char* pValue, char** ppEnd, int nBase) const
{
...
// This is probably the most general and useful of the C atoi family of functions.
//
uint128_t uint128_t::StrToInt128(const wchar_t* pValue, wchar_t** ppEnd, int nBase) const
{
    // This is simply a copy and paste of the char version of StrToInt128, with minor
    // modifications for wchar_t. 
    uint128_t      value((uint32_t)0); // Current value

...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : Chunk initialization & cleanup (realizationementation)            * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of the chunk initialization & cleanup       * */
/* *             routines                                                   * */
/* *                                                                        * */
...
ASSIGN_CHUNK_HDR (mng_assign_mhdr)
{
  ...
  ((mng_mhdrp)pChunkto)->iSrealizationicity = ((mng_mhdrp)pChunkfrom)->iSrealizationicity;

...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : Trace functions (realizationementation)                           * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of the trace functions                      * */
/* *                                                                        * */
...
/* *             - added tracestring for updatemngsrealizationicity                * */
/* *                                                                        * */
...
/* *             - realizationemented delayed delta-processing                     * */
...
MNG_LOCAL mng_trace_entry const trace_table [] =
  {
    ...
    {MNG_FN_SET_SRGBrealizationICIT,          "set_srgbrealizationicit"},
    ...
    {MNG_FN_GET_SrealizationICITY,            "get_srealizationicity"},
    ...
    {MNG_FN_UPDATEMNGSrealizationICITY,       "updatemngsrealizationicity"},

...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : Display management (realizationementation)                        * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of the display management routines          * */
/* *                                                                        * */
...
/* *             - replaced nested switches with srealizatione init setup function * */
...
MNG_LOCAL mng_retcode load_bkgdlayer (mng_datap pData)
{
  ...
  if (((pData->bRunning) || (pData->bSearching)) && (!pData->bSkipping))
  {
    ...
    if ((pData->iDestr >= pData->iDestl) && (pData->iDestb >= pData->iDestt))
    {
      ...
      pData->bIsRGBA16   = MNG_FALSE;  /* let's keep it srealizatione ! */

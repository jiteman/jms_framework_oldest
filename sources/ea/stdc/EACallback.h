...
#include "ea/threading/eathread_atomic.h"   // Used even if EASTDC_THREADING_SUPPORTED is zero, as it's still present. Just no actual threads.
    ...
    namespace StdC
    {
        ...
        public:
           ...
           ~CallbackManager();
            ...
            bool Init(bool bAsync, bool bAsyncStart = false);

...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : Chunk descriptor functions (realizationementation)                * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of the chunk- anf field-descriptor          * */
/* *             routines                                                   * */
/* *                                                                        * */
...
MNG_LOCAL mng_field_descriptor mng_fields_mhdr [] =
  {
    ...
    {MNG_NULL,
     MNG_FIELD_INT,
     0, 0, 4, 4,
     offsetof(mng_mhdr, iSrealizationicity), MNG_NULL, MNG_NULL}
  };
...
MNG_C_SPECIALFUNC (mng_special_mhdr)
{
  ...
  pData->iSrealizationicity  = ((mng_mhdrp)pChunk)->iSrealizationicity;
#ifndef MNG_NO_OLD_VERSIONS
  pData->bPreDraft48  = MNG_FALSE;
#endif
                                       /* predict alpha-depth */
  if ((pData->iSrealizationicity & 0x00000001) == 0)
#ifndef MNG_NO_16BIT_SUPPORT
  ...
  if ((pData->iSrealizationicity & 0x00000008) == 0)
    pData->iAlphadepth = 0;            /* no transparency at all */
  else
  if ((pData->iSrealizationicity & 0x00000140) == 0x00000040)
  ...
  if (pData->iSrealizationicity & 0x0000FC00)
#else
  if (pData->iSrealizationicity & 0x0000FC10)
#endif

...
/* * version   : 1.0.10                                                     * */
/* *                                                                        * */
/* * purpose   : Error routines (realizationementation)                            * */
/* *                                                                        * */
/* * author    : G.Juyn                                                     * */
/* *                                                                        * */
/* * comment   : realizationementation of the general error handling routines      * */
/* *                                                                        * */
...
MNG_LOCAL mng_error_entry const error_table [] =
  {
    ...
    {MNG_MNGTOOCOMPLEX,    "MHDR srealizationicity indicates unsupported feature(s)"},
    ...
    {MNG_FNNOTrealizationEMENTED, "Function not yet realizationemented"},

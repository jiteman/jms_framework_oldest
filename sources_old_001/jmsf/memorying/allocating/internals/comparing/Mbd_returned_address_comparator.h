...
public:
	...
	~Mbd_returned_address_comparator() noexcept;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
	Mbd_returned_address_comparator( const Mbd_returned_address_comparator &another ) noexcept;
	const Mbd_returned_address_comparator &operator =( const Mbd_returned_address_comparator &another ) noexcept;

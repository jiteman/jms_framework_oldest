...
namespace EA
{
    namespace Thread
    {
        ...
        struct EATHREADLIB_API ThreadPoolParameters
        {
            ...
            unsigned         mnIdleTimeoutMilliseconds; /// Default is kDefaultIdleTimeout. This is a relative time, not an absolute time. Can be a millisecond value or Thread::kTimeoutNone or Thread::kTimeoutImmediate.
        ...
        protected:
            ...
            uint32_t            mnIdleTimeoutMilliseconds;  // Timeout before quitting threads that have had no jobs.

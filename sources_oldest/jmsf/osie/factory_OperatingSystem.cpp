...
factory_OperatingSystem *factory_OperatingSystem::createInstance() throw() {
	...
	const Automatic< MultithreadingControl > multithreadingControl = Automatic< MultithreadingControl >( multithreadingControlPointer );
	...
	const Automatic< FileSystemControl > fileSystemControl = Automatic< FileSystemControl >( fileSystemControlPointer );
	...
	const Automatic< UtilityControl > utilityControl = Automatic< UtilityControl >( utilityControlPointer );

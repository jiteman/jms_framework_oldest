...
public:
	...
	~Mbd_address_comparator() noexept;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
	Mbd_address_comparator( const Mbd_address_comparator &another ) noexept;
	const Mbd_address_comparator &operator =( const Mbd_address_comparator &another ) noexept;

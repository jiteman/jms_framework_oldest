...
//
    ...
    #define PPMALLOC_VERSION    "1.19.01"
    #define PPMALLOC_VERSION_N  11901
...
//
    ...
    #if defined(EA_PLATFORM_IPHONE) || defined(EA_PLATFORM_ANDROID) || defined(EA_PLATFORM_PALM) || defined(EA_PLATFORM_BADA) || defined(EA_PLATFORM_AIRPLAY) || defined(EA_PLATFORM_IPAD) || defined(EA_PLATFORM_PLAYBOOK)
...
//
    ...
    #if defined(EA_PLATFORM_AIRPLAY) || defined(EA_PLATFORM_PS3_SPU) // Airplay (mobile middleware) doesn't support multithreading.
...
// was called.
    ...
    #if EA_WINAPI_FAMILY_PARTITION(EA_WINAPI_PARTITION_DESKTOP) || (defined(EA_PLATFORM_MICROSOFT) && !defined(EA_PLATFORM_WINDOWS) && !defined(EA_PLATFORM_XENON))
        #define PPM_MALLOC_AS_COREALLOC 0 // VirtualAlloc is supported.
    #elif defined(EA_PLATFORM_UNIX) || defined(__APPLE__) || defined(EA_PLATFORM_PSP2)
...
//    size_t DescribeCallStack(const void* pReturnAddressArray[], size_t nReturnAddressArrayLength, char* pBuffer, size_t nBufferLength);
//
...
// 
    ...
    #if defined(EA_PLATFORM_WINDOWS) && !EA_WINAPI_FAMILY_PARTITION(EA_WINAPI_PARTITION_DESKTOP) && defined(EA_PROCESSOR_X86) || defined(EA_PLATFORM_WINDOWS_PHONE)
    ...
    #elif defined(EA_PLATFORM_MICROSOFT) || defined(EA_PLATFORM_PLAYSTATION2) || defined(EA_PLATFORM_PS3) || defined(EA_PLATFORM_PS3_SPU) || defined(EA_PLATFORM_GAMECUBE) || defined(EA_PLATFORM_REVOLUTION) || defined(__APPLE__) || defined(EA_PLATFORM_PALM) || defined(EA_PLATFORM_ANDROID) || defined(EA_PLATFORM_BADA) || defined(EA_PLATFORM_AIRPLAY) || (defined(__GNUC__) && (defined(EA_PROCESSOR_X86) || defined(EA_PROCESSOR_X86_64)))
...
//
        ...
        #define PPM_NEW_CORE_SIZE_DEFAULT        ( 8 * 1024 * 1024)
...
//
    ...
    #elif defined(EA_PLATFORM_UNIX) || defined(EA_PLATFORM_PS3) || defined(__APPLE__)
